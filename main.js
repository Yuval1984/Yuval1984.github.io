...
var ListStoreComponent = /** @class */ (function () {
    ...
    ListStoreComponent.prototype.delete = function () {
        for (var i = 0; i < this.stores.length; i++) {
            if (this.current_store.id == this.stores[i].id) {
                alert(this.stores[i].name + " was deleted");
                this.stores.splice(i--, 1);
                break;
            }
        }
